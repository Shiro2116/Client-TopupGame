          ...
          <div className="main-content main-content-card overflow-auto">
            <section className="checkout mx-auto">
              ...
              <div className="purchase pt-30">
                ...
                <Row label="Your Game ID" value="mayzhoier" />
                <Row label="Order ID" value="#GG001" />
                <Row label="Item" value="250 Diamon" />
                <Row label="Price" value={420000} />
                <Row label="Tax 10%" value={420000} />
                <Row label="Total" value={420000} className="color-palette-1" />
              </div>
              <div className="payment pt-10 pb-10">
                <h2 className="fw-bold text-xl color-palette-1 mb-20">Payment Informations</h2>
                <Row label="Your Account Name" value="Syaeful Annas" />
                <Row label="Type" value="Worldwide Transfer" />
                <Row label="Bank Account Name" value="PT SYN CODER" />
