                ...
                <div className="position-relative" data-aos="zoom-in">
                  ...
                  <div className="card left-card position-absolute border-0">
                    <div className="d-flex align-items-center mb-16 gap-3">
                      <Image src={require("/public/img/Header-2.png")} width={40} height={40} className="rounded-pill" alt="" />
                      <div>
                    ...
                    <div className="d-flex gap-2">
                      <Image src={require("/public/icon/star.svg")} width={24} height={22} alt="star" />
                      <Image src={require("/public/icon/star.svg")} width={24} height={22} alt="star" />
                      <Image src={require("/public/icon/star.svg")} width={24} height={22} alt="star" />
                      <Image src={require("/public/icon/star.svg")} width={24} height={22} alt="star" />
                      <Image src={require("/public/icon/star.svg")} width={24} height={22} alt="star" />
